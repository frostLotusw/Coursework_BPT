...
public:
    ...
    static constexpr int leaf_size = 24, internal_size = 168;
    static constexpr int leaf_merge_size = 10, internal_merge_size = 70;
    static constexpr int page_size = 2048, cache_limit = 16384;
